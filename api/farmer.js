export default async function handler(req, res) {
  ...
  const rows = [
    ...
    ['Sells via', data.buyMethods],
    ['Accepting customers', data.customers],
    ['Certifications', data.certifications || '—'],
    ['Minority-owned', data.minority || '—'],
    ['Identity', data.minorityId || '—'],
    ['Self-describe', data.selfDescribe || '—'],
  ...
  const storyBlock = data.story ? `
    <div style="margin-top:1.5rem;padding:1rem;background:#EDE8DC;border-radius:6px;">
    ...
    body: JSON.stringify({
      ...
      html: `
        <div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;padding:2rem;color:#2C1A0E;background:#FAF5EC;">
          <p style="color:#C1622F;font-size:0.75rem;letter-spacing:0.1em;text-transform:uppercase;">
            Terra 159 — New Farm Directory Submission
          </p>
